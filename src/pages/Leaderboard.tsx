              ...
              <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'end', gap: 4, py: 4 }}>
                ...
                {leaderboard[1] && (
                  <Box sx={{ textAlign: 'center' }}>
                    <Box sx={{ position: 'relative', mb: 2 }}>
                      <Avatar
                        src={leaderboard[1].avatar ? `${process.env.REACT_APP_API_URL || 'http://localhost:5000'}/uploads/avatars/${leaderboard[1].avatar}` : undefined}
                        sx={{
                          width: 80,
                          height: 80,
                          mx: 'auto',
                ...
                {leaderboard[0] && (
                  <Box sx={{ textAlign: 'center' }}>
                    <Box sx={{ position: 'relative', mb: 2 }}>
                      <Avatar
                        src={leaderboard[0].avatar ? `${process.env.REACT_APP_API_URL || 'http://localhost:5000'}/uploads/avatars/${leaderboard[0].avatar}` : undefined}
                        sx={{
                          width: 100,
                          height: 100,
                          mx: 'auto',
                ...
                {leaderboard[2] && (
                  <Box sx={{ textAlign: 'center' }}>
                    <Box sx={{ position: 'relative', mb: 2 }}>
                      <Avatar
                        src={leaderboard[2].avatar ? `${process.env.REACT_APP_API_URL || 'http://localhost:5000'}/uploads/avatars/${leaderboard[2].avatar}` : undefined}
                        sx={{
                          width: 80,
                          height: 80,
                          mx: 'auto',
                ...
                {leaderboard.map((entry, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <ListItemAvatar>
                        <Avatar
                          src={entry.avatar ? `${process.env.REACT_APP_API_URL || 'http://localhost:5000'}/uploads/avatars/${entry.avatar}` : undefined}
                          sx={{
